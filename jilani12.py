...
def traiter_image_et_calculer_somme(image_path):
    """
...
def main():
    ...
    image_path = "M7.jpg"  # Nom temporaire, remplacez par le chemin réel de l'image

    print("=============== DÉBUT DU TRAITEMENT ===============")
    somme_image = traiter_image_et_calculer_somme(image_path)
    print("===================================================")
