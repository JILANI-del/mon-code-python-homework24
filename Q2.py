...
# AJUSTEMENT 
limite_acceptation = 0.62

def ajouter_bruit_selp_poivre(image, noise_level=0.002):
    """
...
def traiter_image_et_calculer_somme(image_path, noise_level=0.002):
    """
    Détecte les pièces par Hough avec ajout de bruit sel-et-poivre.
    """
...
def main():
    ...
    """
    # Chemin de l'image uploadée (à adapter selon votre environnement)
    image_path = "M5.jpg"  # Modifié pour M5.jpg
    noise_level = 0.002 # Niveau de bruit réglable (0 à 0.5 recommandé)
